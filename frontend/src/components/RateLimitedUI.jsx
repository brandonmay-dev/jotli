...
const RateLimitedUI = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 min-h-[60vh] flex items-center justify-center">
      <div className="bg-primary/10 border border-primary/30 rounded-lg shadow-md animate-pulse">
        <div className="flex flex-col md:flex-row items-center p-6">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-base-content/90 mb-1">
            ...
            <button className="btn btn-primary btn-sm mt-3">Try Again</button>
          </div>
        </div>
      </div>
    </div>
